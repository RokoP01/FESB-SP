/*Napisati program koji ?ita datoteku drzave.txt u kojoj su zapisani nazivi pojedinih država. Uz
...
broj_stanovnika.
a) Potrebno je formirati sortiranu vezanu listu država po nazivu. Svaki ?vor vezane liste
sadrži stablo gradova sortirano po broju stanovnika, zatim po nazivu grada.
b) Potrebno je formirati stablo država sortirano po nazivu. Svaki ?vor stabla sadrži vezanu
listu gradova sortiranu po broju stanovnika, zatim po nazivu grada.
Nakon formiranja podataka potrebno je ispisati države i gradove te omogu?iti korisniku putem
tastature pretragu gradova odre?ene države koji imaju broj stanovnika ve?i od unosa na
tastatur*/
